...
<div class="container spacethis">
	<div class="row">
		<aside class="col-md-3">
			<div class="sidebox">
				<h4 class="theme-color"><b>Categories</b></h4>
				<ul class="cllist">
					<li class="checkbox">
					  <input id="24184" class="btn" type="checkbox" name="products[]">
					  <label class="check-label" for="24184"></label>
					  <label for="24184">this is label</label>
					</li>
					<li class="checkbox">
						  <input id="24184" class="btn" type="checkbox" name="products[]">
						  <label class="check-label" for="24184"></label>
			...
			<div class="sidebox" style="padding-right: 35px;">
				<h4 class="theme-color"><b>Price Filter</b></h4>
				<br>
				...
				<div class="form-group mt40">
					<form class="form-inline row range-form">
						<div class="col-md-6">
							<div class="row">
						...
						<div class="col-md-6">
							<div class="row">
								<label for="" class="col-md-6 text-right">To</label>
								<input type="text" class="col-md-6">
							</div>
